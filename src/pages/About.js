...
const About = () => (
  <section className="about">
    <h1 className="about__title">Acerca de</h1>
    <div className="info">
      ...
      <div className="info__description">
        <p className="info__description--paragraph">
          Estudiando en Make It Real, ampliando mis conocimientos en diversos
          temas de desarrollo web para ser un Desarrollador FullStack
          competente.
        </p>
      </div>
      <div className="info__learn">
        ...
        <ul className="info__list">
          <li className="info__list--item">
            Correcto manejo de Hooks en React
          </li>
          <li className="info__list--item">
            HTTP, CORS y autenticaci&oacute;n
          </li>
          <li className="info__list--item">
      ...
      <div className="info__network">
        <h4 className="info__network--title">Contacto</h4>
